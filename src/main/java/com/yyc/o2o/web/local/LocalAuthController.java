...
public class LocalAuthController {
    ...
    @RequestMapping(value = "/bindlocal",method = RequestMethod.GET)
    @ResponseBody
    /**
     * 本地账号绑定
     *@params:[request]
    ...
    private Map<String, Object> changeLocalPwd(HttpServletRequest request) {
        ...
        if (userName != null && password != null && newPassword != null && user != null && user.getUserId() != null
            ...
            try {
                ...
                // 修改平台帐号的用户密码
                LocalAuthExecution le = localAuthService.modityLocalAuth(user.getUserId(), userName, password,
                        newPassword);
                if (le.getState() == LocalAuthStateEnum.SUCCESS.getState()) {
                    modelMap.put("success", true);
                } else {
    ...
    private Map<String, Object> logincheck(HttpServletRequest request) {
        Map<String, Object> modelMap = new HashMap<String, Object>();
        // 获取是否需要进行验证码校验的标识符，当密码输入错误超过3次就要输入验证码
